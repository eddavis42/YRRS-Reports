...
year1 <- read_dta("YRRS/County & District Reports/Datasets/nmMS_2011yrrs_NM_v1.dta")
year1<-subset(year1, fwtlvl_cnty!="")
yrrs_cnty_1 <- svydesign(id=~psu, strata=~stratum, weights=~fwtlvl_cnty, data=year1)


year2 <- read_dta("YRRS/County & District Reports/Datasets/nmMS2013YRRS_nm_v2.dta")
year2<-subset(year2, fwt_cnty!="")
yrrs_cnty_2 <- svydesign(id=~psu, strata=~strata, weights=~fwt_cnty, data=year2)


year3 <- read_dta("YRRS/County & District Reports/Datasets/nmMS2015YRRS_nm_v3.dta")
yrrs_cnty_3 <- svydesign(id=~psu, strata=~strata, weights=~fwt_cnty, data=year3)


year4 <- read_dta("YRRS/County & District Reports/Datasets/nmMS2017YRRS_nm_v2.dta")
yrrs_cnty_4 <- svydesign(id=~psu, strata=~strata, weights=~fwt_cnty, data=year4)


year5 <- read_dta("YRRS/County & District Reports/Datasets/nmMS2019YRRS_nm_v3.dta")
...
```{r Testing, echo=FALSE, warning=FALSE, message=FALSE, fig.height = 17, fig.width=12, fig.align = "center"}
barplot_grade(c("fight", "liveoutus", "uslive"), "Other Behaviors and Characteristics",ms=TRUE)
barplot_group(c("fight", "liveoutus", "uslive"), "Other Behaviors and Characteristics",ms=TRUE)
a <- barplot_resiliency("sad", c("r3phobby","r3pconted", "r3fhelp", "r3fcare", "r3cgroup", "r3cgoodjob", "r3ccare", "r3sgroup", "r3srule", "r3ssuccess", "r3slisten", "r3hknow", "r3hsuccess", "r3hintscl"), "region")
a <- a + labs(caption = paste0("How to read this chart:\n
 Of those who said it was 'Not true at all' that a parent or other adult was interested in their school work, ",
 risk_props[1],
 "% attempted suicide.\n
 Of those who said it was 'A little but or pretty much true' that a parent or other adult was interested in their school work, ",
 risk_props[2],
 "% attempted suicide.\n
 Of those who said it was 'Very much true' that a parent or other adult was interested in their school work, ",
 risk_props[3],
 "% attempted suicide."))
...
yrbss_hs_cnty <- subset(yrbss_NM, cntytxt=={params$counties})
#Response rates
